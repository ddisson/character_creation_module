...
###Вычисляем атаку в зависимости от класса персонажа.###
...
def defence(char_name: str, char_class: str) -> str:
    ###Вычисляем блоки в зависимости от класса персонажа.###
    if char_class == 'warrior':
    ...
    return (f'{char_name} 0 урона')


def special(char_name: str, char_class: str) -> str:
    ###Применяем специальное умение в зависимости от класса персонажа.###
    if char_class == 'warrior': 
